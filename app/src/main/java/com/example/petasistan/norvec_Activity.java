...
public class norvec_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_norvec);
    ...
    public void yukleilan(){
        ...
        webilanView.loadUrl("https://en.wikipedia.org/wiki/Norwegian_Forest_cat");
